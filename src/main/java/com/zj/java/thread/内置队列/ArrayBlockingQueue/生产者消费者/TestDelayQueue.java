...
/**
 * @Author: zhoujun
 * @Date: 2023/2/19 11:44
 */

@SuppressWarnings("unchecked")
public class TestDelayQueue<E extends Delayed> extends AbstractQueue<E>
        implements BlockingQueue<E> {

    private final transient ReentrantLock lock = new ReentrantLock();
    /**
     * 使用 PriorityQueue 存放数据
     */
    ...
    public TestDelayQueue(Collection<? extends E> c) {
        this.addAll(c);
    }
    ...
    public Iterator<E> iterator() {
        return new TestDelayQueue.Itr(toArray());
    }
    ...
    static class DelayedEle implements Delayed {
        ...
        public String toString() {
            return "DelayedEle{" + "delay=" + delayTime +
                    ", expire=" + expire +
                    ", taskName='" + taskName + '\'' +
                    '}';
        }
